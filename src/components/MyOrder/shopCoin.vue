<template>
	<div class="wrap">
		<h4><span @click='changeView("view10")'>我的帅柏</span>&nbsp;<i>&gt;</i>&nbsp;<span @click='changeView("vip7")'>资金管理</span>&nbsp;<i>&gt;</i>&nbsp;<span @click='changeView("vip72")'>购物积分</span></h4>
		<dl class="amountInfo">
			<dt><span>当前购物积分</span><em v-text='shoppingCoinInfo.shopping_coin'></em>
			</dt>
		</dl>
		<div class="title">
	 		<i class="icon"></i>
